# this file was created by Evan Hersey
...
Platforms: Desert-stone platforms / Moving Desert-stone platforms (randomly generated)
...
class Game:
    ...
    def new(self):
        ...
        for plat in PLATFORM_LIST:
            ...
            # self.mlatforms.add(p)
        for i in range(8):
            c = Cloud(self)
            c.rect.y += 500
        # load music
        pg.mixer.music.load(path.join(self.snd_dir, 'now_connormusic.ogg'))
        # call the run method
        self.run()
    def run(self):
        # game loop
    ...
    def show_start_screen(self):
        ...
        self.draw_text("GUESS RANDOM KEYS TO JUMP", 22, WHITE, WIDTH/2, HEIGHT/2)
        self.draw_text("SMASH YOUR FACE INTO THE KEYBOARD TO START", 22, WHITE, WIDTH / 2, HEIGHT * 3/4)
    ...
    def show_go_screen(self):
        ...
        self.draw_text("WASTED", 48, REDDISH, WIDTH/2, HEIGHT/4)
        self.draw_text("YOU'RE TERRIBLE", 22, WHITE, WIDTH/2, HEIGHT/2)
